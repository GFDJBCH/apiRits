...
class Sucursales extends Connection
{
    ...
    {
        $query = "SELECT * FROM " . $this->table . " where Tipo = 'COTI_SUCURSALES';";
        return parent::getData($query);
    }
    public function listaSucursalesRevision()
    {
        $query = "SELECT DISTINCT(idSucursal) as idSucursal, codigoSucursal, descripcionSucursal FROM vw_cdc_clasificacion WHERE idSucursal IS NOT NULL;";
        return parent::getData($query);
    }
