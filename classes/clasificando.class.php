...
class Clasificando extends Connection
{
    ...
    public function listaClasificando($page = 1)
    {
        $start = 0;
        $qty = 20;
        if ($page > 1):
        ...
        $query = "SELECT * FROM " . $this->tableView . " WHERE ValorTexto = 'CLASIFICANDO' limit $start,$qty";
